...
@Composable
fun FavouriteToggleIconButton(breed: DogBreed, onFavoriteToggle: (DogBreed) -> Unit) {
    val isFavouriteState = rememberUpdatedState(breed.isFavourite)
    ...
    IconButton(
        ...
        Icon(
            imageVector = if (isFavouriteState.value) Icons.Filled.Star else Icons.Outlined.Star,
